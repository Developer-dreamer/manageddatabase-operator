...
import (
	...
	"github.com/Developer-dreamer/manageddatabase-operator.git/internal/controller"
...
func main() {
	...
	flag.StringVar(&provisionerURL, "provisioner-url", "http://localhost:8080", "The provisioner URL")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "16936c93.example.com",
