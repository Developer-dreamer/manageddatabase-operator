...
KIND_CLUSTER ?= manageddatabase-operator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name manageddatabase-operator-builder
	$(CONTAINER_TOOL) buildx use manageddatabase-operator-builder
	...
	- $(CONTAINER_TOOL) buildx rm manageddatabase-operator-builder
	rm Dockerfile.cross
